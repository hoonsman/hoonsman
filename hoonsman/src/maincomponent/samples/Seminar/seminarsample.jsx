  ...
  return (
    <div className="wrapper" style={{ maxWidth: size.width || 380 }}>
      <div className="container">
        ...
        >
          <div className="slider" ref={(el) => (sliderRefs.current[0] = el)}>
            <img
          ...
          <p
            ...
            style={{
              fontSize:
                seminarData.scenes[0].messages[0].size === 'small'
                  ? '12px'
                  : seminarData.scenes[0].messages[0].size === 'medium'
                  ? '18px'
                  : seminarData.scenes[0].messages[0].size === 'large'
                  ? '24px'
                  : '12px',
        ...
        >
          <div className="slider" ref={(el) => (sliderRefs.current[1] = el)}>
            <img
            ...
            style={{
              fontSize:
                seminarData.scenes[1].messages[0].size === 'small'
                  ? '12px'
                  : seminarData.scenes[1].messages[0].size === 'medium'
                  ? '18px'
                  : seminarData.scenes[1].messages[0].size === 'large'
                  ? '24px'
                  : '12px',
            ...
            style={{
              fontSize:
                seminarData.scenes[1].messages[1].size === 'small'
                  ? '12px'
                  : seminarData.scenes[1].messages[1].size === 'medium'
                  ? '18px'
                  : seminarData.scenes[1].messages[1].size === 'large'
                  ? '24px'
                  : 'inherit',
        ...
        >
          <div className="slider" ref={(el) => (sliderRefs.current[2] = el)}>
            <img
            ...
            style={{
              fontSize:
                seminarData.scenes[2].messages[0].size === 'small'
                  ? '12px'
                  : seminarData.scenes[2].messages[0].size === 'medium'
                  ? '18px'
                  : seminarData.scenes[2].messages[0].size === 'large'
                  ? '24px'
                  : '12px',
            ...
            style={{
              fontSize:
                seminarData.scenes[2].messages[1].size === 'small'
                  ? '12px'
                  : seminarData.scenes[2].messages[1].size === 'medium'
                  ? '18px'
                  : seminarData.scenes[2].messages[1].size === 'large'
                  ? '24px'
                  : '12px',
            ...
            style={{
              fontSize:
                seminarData.scenes[3].messages[0].size === 'small'
                  ? '12px'
                  : seminarData.scenes[3].messages[0].size === 'medium'
                  ? '18px'
                  : seminarData.scenes[3].messages[0].size === 'large'
                  ? '24px'
                  : '12px',
            ...
            style={{
              fontSize:
                seminarData.scenes[3].messages[1].size === 'small'
                  ? '12px'
                  : seminarData.scenes[3].messages[1].size === 'medium'
                  ? '18px'
                  : seminarData.scenes[3].messages[1].size === 'large'
                  ? '24px'
                  : '12px',
        ...
        >
          ...
          <p
            ...
            style={{
              fontSize:
                seminarData.scenes[4].messages[0].size === 'small'
                  ? '12px'
                  : seminarData.scenes[4].messages[0].size === 'medium'
                  ? '18px'
                  : seminarData.scenes[4].messages[0].size === 'large'
                  ? '24px'
                  : '12px',
