...
const calcOpacity = (ratio, opacity, ratioRange) => {
  let op
  if (opacity[0] > 0)
    op = opacity[0] - (ratio - ratioRange[0]) / (ratioRange[1] - ratioRange[0])
...
const data = {
  ...
  scene3: {
    ...
    message: {
      ...
      4: {
        content: '소중한 인연과 귀한 발걸음, 저희도 발맞추어 살아가겠습니다',
        size: 'medium',
        color: 'white',
      },
    },
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene1.message[1].size === 'small'
                        ? 18
                        : data.scene1.message[1].size === 'medium'
                        ? 25
                        : data.scene1.message[1].size === 'large' && 32
                    }px`,
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene1.message[2].size === 'small'
                        ? 18
                        : data.scene1.message[2].size === 'medium'
                        ? 25
                        : data.scene1.message[2].size === 'large' && 32
                    }px`,
                  }}
                >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene2.message[1].size === 'small'
                        ? 18
                        : data.scene2.message[1].size === 'medium'
                        ? 25
                        : data.scene2.message[1].size === 'large' && 32
                    }px`,
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene2.message[2].size === 'small'
                        ? 18
                        : data.scene2.message[2].size === 'medium'
                        ? 25
                        : data.scene2.message[2].size === 'large' && 32
                    }px`,
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene2.message[3].size === 'small'
                        ? 18
                        : data.scene2.message[3].size === 'medium'
                        ? 25
                        : data.scene2.message[3].size === 'large' && 32
                    }px`,
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene2.message[4].size === 'small'
                        ? 18
                        : data.scene2.message[4].size === 'medium'
                        ? 25
                        : data.scene2.message[4].size === 'large' && 32
                    }px`,
                  }}
                >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene3.message[1].size === 'small'
                        ? 18
                        : data.scene3.message[1].size === 'medium'
                        ? 25
                        : data.scene3.message[1].size === 'large' && 32
                    }px`,
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene3.message[2].size === 'small'
                        ? 18
                        : data.scene3.message[2].size === 'medium'
                        ? 25
                        : data.scene3.message[2].size === 'large' && 32
                    }px`,
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene3.message[3].size === 'small'
                        ? 18
                        : data.scene3.message[3].size === 'medium'
                        ? 25
                        : data.scene3.message[3].size === 'large' && 32
                    }px`,
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene3.message[4].size === 'small'
                        ? 18
                        : data.scene3.message[4].size === 'medium'
                        ? 25
                        : data.scene3.message[4].size === 'large' && 32
                    }px`,
                  }}
                >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene4.message[1].size === 'small'
                        ? 18
                        : data.scene4.message[1].size === 'medium'
                        ? 25
                        : data.scene4.message[1].size === 'large' && 32
                    }px`,
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: `${
                      data.scene4.message[2].size === 'small'
                        ? 18
                        : data.scene4.message[2].size === 'medium'
                        ? 25
                        : data.scene4.message[2].size === 'large' && 32
                    }px`,
                  }}
                >
